...
const teamInfo = require('../public/js/teamData'); // Updated import path
...
describe('teamInfo', () => {
    ...
    // tests each team member has required properties
    ...
    describe('teamInfo images', () => {
        it('should have a corresponding image for each member', () => {
            teamInfo.forEach(member => {
                ...
                const imagePath = path.join(__dirname, '../public/img', imageName); // Adjusted the relative path
